...
namespace Linq
{
    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<string> DistinctPropertyValues()
        {
            ...
            var querry = products.Select(x => x.Category).Distinct();
            return querry;
        }
        ...
        public static IEnumerable<int> Union()
        {
            ...
            var querry = numbersA.Union(numbersB);
            return querry;
        }
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            var query = products.Select(p => p.ProductName[0]).Union(customers.Select(c => c.CompanyName[0]));
            return query;
        }
        ...
        public static IEnumerable<int> Intersect()
        {
            ...
            var querry = numbersA.Intersect(numbersB);
            return querry;
        }
        ...
        public static IEnumerable<int> DifferenceOfSets()
        {
            ...
            var query = numbersA.Except(numbersB);
            return query;
        }
